...
export function StickyScrollRevealDemo() {
  return (
    <div className="w-full py-40">
      <div className="flex flex-col items-center font-funnel pb-20">
        <h1 className="text-7xl font-bold">
          My <span className="text-purple">Journey</span>
        </h1>
        <p className="text-3xl text-center font-medium w-[70vw] lg:w-[40vw] text-slate-300 mt-4">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
          tristique, nulla et aliquam tincidunt, nisl nisi aliquet nisl, sed
          aliquet nisl nisi nisl.
        </p>
      </div>
      <div className="w-full 2xl:flex  justify-center gap-10 items-center pb-20 ">
